            ...
            <div className="row">
                <div className="col-12">
                    <div className="page-title-box">
                        ...
                        <h4 className="page-title">Welcome to the Library Management System</h4>
                    </div>
                </div>
            </div>
                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card widget-flat text-bg-pink">
                        <div className="card-body">
                            ...
                            <h6 className="text-uppercase mt-0" title="Customers">Total Books</h6>
                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card widget-flat text-bg-purple">
                        <div className="card-body">
                            ...
                            <h6 className="text-uppercase mt-0" title="Customers">Total Readers</h6>
                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card widget-flat text-bg-info">
                        <div className="card-body">
                            ...
                            <h6 className="text-uppercase mt-0" title="Customers">Books Issued</h6>
                            {/* <h2 class="my-2">
                                  <?php
                                   echo Borrow::count();
                                  ?>
                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card widget-flat text-bg-primary">
                        <div className="card-body">
                            ...
                            <h6 className="text-uppercase mt-0" title="Customers">Books Available</h6>
